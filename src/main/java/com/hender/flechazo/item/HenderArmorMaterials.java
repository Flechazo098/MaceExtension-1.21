...
public class HenderArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> HENDER_TOOL= register("hender_tool", Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 8);//下面第一个是附魔等级的机会（数值越高附魔出好魔咒的概率就高），第二个是韧性，第三个是抗击退
    }), 114514, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 20, 23, () -> Ingredient.ofItems(ModItems.HENDER_TOOL));
