...
import com.hender.flechazo.block.entity.BoxBlockEntity;
...
public class BoxBlock extends AbstractChestBlock<BoxBlockEntity> {
    ...
    public static final MapCodec<BoxBlock> CODEC = createCodec(Settings -> new BoxBlock(Settings, () -> HenderBlockEntities.HENDER_BOX));
